              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <span style="color: red"
                    >IF("{RECAPTCH_ERROR}"!=""){ {RECAPTCH_ERROR} {:IF}</span
                  >
                </div>
              </div>
            </div>
...
IF("{MAP_TYPE}"=="google"){
<link
  href="{SITE_URL}includes/assets/plugins/map/google/map-marker.css"
  type="text/css"
  rel="stylesheet"
/>
<script
  type="text/javascript"
  src="{SITE_URL}includes/assets/plugins/map/google/jquery-migrate-1.2.1.min.js"
></script>
<script
  type="text/javascript"
  src="//maps.google.com/maps/api/js?key={GMAP_API_KEY}&#038;libraries=places%2Cgeometry&#038;ver=2.2.1"
></script>
<script
  type="text/javascript"
  src="{SITE_URL}includes/assets/plugins/map/google/richmarker-compiled.js"
></script>
<script
  type="text/javascript"
  src="{SITE_URL}includes/assets/plugins/map/google/markerclusterer_packed.js"
></script>
<script
  type="text/javascript"
  src="{SITE_URL}includes/assets/plugins/map/google/gmapAdBox.js"
></script>
<script
  type="text/javascript"
  src="{SITE_URL}includes/assets/plugins/map/google/maps.js"
></script>
<script>
...
<link
  rel="stylesheet"
  href="{SITE_URL}includes/assets/plugins/map/openstreet/css/style.css"
/>
